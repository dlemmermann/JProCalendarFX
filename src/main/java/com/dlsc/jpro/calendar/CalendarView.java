...
import com.calendarfx.view.page.DayPage.DayPageLayout;
...
/**
 * A full uk.co.senapt.desktop.ui.modules.calendar view with multiple pages for displaying a single day, a week,
 * a month, and an entire year. The view also includes two trays, one for seeing
 * all uk.co.senapt.desktop.ui.modules.calendar sources, and one for seeing the results of the current search.
 * The trays can be shown or hidden. Another nice feature is direct support for
 * printing (see {@link #getPrintView()}).
 * <p/>
 * <center><img width="100%" src="doc-files/uk.co.senapt.desktop.ui.modules.calendar-view.png"></center>
 */
public class CalendarView extends DateControl {
    ...
    private final InvalidationListener fixSelectedPageListener = it -> fixSelectedPage();
     ...
     * various types of events that are fired by the uk.co.senapt.desktop.ui.modules.calendar while the user is
     * using it.
     *
     ...
     * Returns the value of {@link #showSourceTrayProperty()}.
     *
     * @return true if the uk.co.senapt.desktop.ui.modules.calendar source tray gets shown to the user
     */
     ...
     * uk.co.senapt.desktop.ui.modules.calendar view. The skin of this view uses a {@link BorderPane} to lay out
     ...
     *
     * @return the node that will be shown above the actual uk.co.senapt.desktop.ui.modules.calendar
     */
     ...
     *
     * @param node a node that will be shown above the actual uk.co.senapt.desktop.ui.modules.calendar
     */
     ...
     *
     * @return the header node shown below the actual uk.co.senapt.desktop.ui.modules.calendar
     */
     ...
     *
     * @param node a node that will be shown below the actual uk.co.senapt.desktop.ui.modules.calendar
     */
    ...
    /**
     * Controls whether the "add uk.co.senapt.desktop.ui.modules.calendar" button in the upper left corner of
     * the control will be shown to the user or not.
     *
     * @return true if the "add uk.co.senapt.desktop.ui.modules.calendar" button will be accessible by the user
     */
     ...
     *
     * @param show if true the "add uk.co.senapt.desktop.ui.modules.calendar" button will be accessible by the
     *             user
     */
    ...
    /**
     * Sends the request to the uk.co.senapt.desktop.ui.modules.calendar view to display the given date. The
    ...
    /**
     * Sends the request to the uk.co.senapt.desktop.ui.modules.calendar view to display the given week. The
    ...
    /**
     * Sends the request to the uk.co.senapt.desktop.ui.modules.calendar view to display the given date and
    ...
    /**
     * Sends the request to the uk.co.senapt.desktop.ui.modules.calendar view to display the given year and
    ...
    /**
     * Sends the request to the uk.co.senapt.desktop.ui.modules.calendar view to display the given year. The
    ...
    public ObservableList<Item> getPropertySheetItems() {
        ...
        items.add(new Item() {
            ...
            public String getDescription() {
                return "Show or hide the uk.co.senapt.desktop.ui.modules.calendar tray on the left"; //$NON-NLS-1$
            }
